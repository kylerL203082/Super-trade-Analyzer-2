...
def main():
    ...
    injury_by_name = (
        latest_injury_by_name(
            injuries
        )
    )


    snap_by_name = defaultdict(
        list
    )
    ...
    print(
        ...
        "TradeForge feed built: "
        f"{updated}/{len(baseline)} "
        "players auto-updated; "
        f"season {SEASON}, "
